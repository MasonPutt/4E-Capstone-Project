...
typologies <- typologies %>%
  select(county_state, metro, farming_dep, mining_dep, manufac_dep, gov_dep, recreation_dep, nonspecialized, low_educ) %>%
...
alldata5yr <- rbind(alldata5yr_12, alldata5yr_17) %>%
  select(1, 23, 3:6, 9:22, 25:89, 91:98) %>%
  arrange(county_state)
